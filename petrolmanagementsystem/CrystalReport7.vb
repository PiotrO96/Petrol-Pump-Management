...
Public Class CrystalReport7
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "petrolmanagementsystem.CrystalReport7.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport7
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport7 = New CrystalReport7
        rpt.Site = Me.Site
        Return rpt
    End Function

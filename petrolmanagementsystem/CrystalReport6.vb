...
Public Class CrystalReport6
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "petrolmanagementsystem.CrystalReport6.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport6
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport6 = New CrystalReport6
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class CrystalReport9
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "petrolmanagementsystem.CrystalReport9.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport9
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport9 = New CrystalReport9
        rpt.Site = Me.Site
        Return rpt
    End Function

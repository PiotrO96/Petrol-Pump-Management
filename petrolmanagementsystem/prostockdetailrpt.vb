...
Public Class prostockdetailrpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "petrolmanagementsystem.prostockdetailrpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedprostockdetailrpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As prostockdetailrpt = New prostockdetailrpt
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class CrystalReport12
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "petrolmanagementsystem.CrystalReport12.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport12
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport12 = New CrystalReport12
        rpt.Site = Me.Site
        Return rpt
    End Function

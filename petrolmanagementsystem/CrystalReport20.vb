...
Public Class CrystalReport20
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "petrolmanagementsystem.CrystalReport20.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport20
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport20 = New CrystalReport20
        rpt.Site = Me.Site
        Return rpt
    End Function
